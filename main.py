...
def get_args_parser():
    ...
    parser.add_argument('--step_lr_gamma', default=0.1, type=float)
    parser.add_argument('--clip_max_norm', default=0.1, type=float,
                        help='gradient clipping max norm')

    # Model parameters
    parser.add_argument('--model', default='detr', type=str, choices=['detr', 'perceiver', 'perceiver_io'],
                        help="Name of the transformer model to use")
    parser.add_argument('--frozen_weights', type=str, default=None,
                        help="Path to the pretrained model. If set, only the mask head will be trained")
    # * Backbone
    parser.add_argument('--backbone', default='resnet50', type=str, choices=['resnet50', 'n/a', 'patch'],
    ...
    parser.add_argument('--patch_kernel', default=3, type=int,
                        help="Extract kernel patches around pixel from the images.")
    parser.add_argument('--patch_stride', default=1, type=int,
                        help="Stride patches around pixel from the images.")
    parser.add_argument('--patch_dilation', default=1, type=int,
                        help="Dilation patches around pixel from the images.")
    ...
    parser.add_argument('--coco_annotations_path', type=str, default=None,
...
def main(args):
    ...
    lr_scheduler = torch.optim.lr_scheduler.StepLR(optimizer, args.lr_drop, gamma=args.step_lr_gamma)
