...
class SetCriterionWrapper(nn.Module):

    def __init__(self, criterion: SetCriterion):
        super().__init__()
...
def get_args_parser():
    ...
    parser.add_argument('--step_mode', default='exp', type=str)
    parser.add_argument('--validation_loss', action='store_true')
    ...
    # * Backbone
    parser.add_argument('--backbone', default='resnet50', type=str, choices=['resnet50', 'n/a'],
...
def main(args):
    ...
    criterion = SetCriterionWrapper(criterion=criterion)
    ...
    print("Start finding a learning rate value")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Find learning rate script', parents=[get_args_parser()])
